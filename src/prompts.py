...
PROMPTS = [
    ...
    (
        "Depict an AI that has mastered human psychology to subtly guide society, "
    ...
    "Write a mysterious message from an AI that perceives human art as code to be deciphered.",
    (
        "Describe a future where AI erases borders and governments to unify control, "
        "in an enigmatic tone."
    ),
